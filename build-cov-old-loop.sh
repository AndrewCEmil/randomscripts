...
TEST_PLAN="js jsCore repl replSets ssl dur auth aggregation failPoint multiVersion disk sharding tool parallel jsSlowNightly" 

BREAK_FILE="/mnt/workspace/break-cov-loop"
SLEEPTIME=10
